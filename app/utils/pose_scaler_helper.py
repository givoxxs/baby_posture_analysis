...
class PoseScalerHelper:
    ...
    def find_center_of_babay(self, df_keypoints):
        ...
        left_shoulder = (
            df_keypoints["left_shoulder_x"],
            df_keypoints["left_shoulder_y"],
        )
        right_shoulder = (
            df_keypoints["right_shoulder_x"],
            df_keypoints["right_shoulder_y"],
        )
        ...
        resp = (center_hip[0] + center_shoulder[0]) / 2, (
